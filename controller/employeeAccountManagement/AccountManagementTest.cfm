...
<div class="container">
  <div class="sidebar1">
    ...
    <!-- end .sidebar1 --></div>
  <div class="content">
    <h1>Coldfusion Test Page</h1>
    <p>&nbsp;</p>
    <h3>New Employee Function Test</h3>
    <cfinvoke component="createNewEmployeeController.cfc" method="createNewEmployeeProfile" />
    <p>&nbsp;</p>
    <h3>Employee Record Update Function Test</h3>
    <p>&nbsp;</p>
  <!-- end .content --></div>
  <div class="sidebar2">
    <h4>Backgrounds</h4>
